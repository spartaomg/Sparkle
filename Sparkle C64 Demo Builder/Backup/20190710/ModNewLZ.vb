...
NextPart:
            ...
            If ByteSt.Count > BlockPtr Then     'Only save block count if block as already added to ByteSt
                ByteSt(BlockPtr) = LastBlockCnt
                'LoaderParts += 1
                'MsgBox(LoaderParts.ToString)
            Else
                'MsgBox(ByteSt.Count.ToString + vbTab + BlockPtr.ToString)
            End If
